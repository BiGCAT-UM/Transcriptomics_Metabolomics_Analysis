...
---
## Introduction
In this workflow, extracting overlapped differential expressed genes between Crohn`s disease and ulcerative colitis will be performed. 
...
#read dataset to be processed for biopsy location
if (location == "ileum") {
...
setwd(dirname(rstudioapi::getSourceEditorContext()$path))
```
## Getting ENTREZ IDs for gene symbols
...
## Finding overlapped genes between diseases on bioopsy location
```{r}
