...
setwd('..')
work_DIR <- getwd()
#we have two datasets for different diseases
dataset1 <- read.delim("3-identifier_mapping/output/IDMapping_CD.tsv")
dataset2 <- read.delim("3-identifier_mapping/output/IDMapping_UC.tsv")
