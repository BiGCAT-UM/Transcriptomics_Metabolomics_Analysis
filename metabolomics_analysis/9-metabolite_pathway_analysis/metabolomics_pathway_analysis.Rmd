...
colnames(pathwayAnalysis_results)[6] <- "Proteins.In.PW"

##Sort PW results based on 1. #HMDBs in PW, 2. relevant p-values (lower then or equal to 0.05), 3. number of proteins in PW (which might be relevant for transcriptomics analysis)
