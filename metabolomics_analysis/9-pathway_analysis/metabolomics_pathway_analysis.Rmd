...
list_Relevant_HMDB_IDs <- na.exclude(mSet$relevant_labels)
##Add the HMDb prefix IRI in front of all IDs.
split_string_HMDB <- as.list(strsplit(list_Relevant_HMDB_IDs, ' ')[[1]])
cleaned_string_HMDB <- as.list(str_replace(split_string_HMDB, "ch:", ""))
...
query_CombinePWs <- paste(item1,list_Relevant_HMDB_IDs,item2)
remove(item1, item2)
