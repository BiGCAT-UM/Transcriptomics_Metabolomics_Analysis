...
To do so, gene and metabolites data are processed to have ensembelIDs and ChEBI IDS and corresponding log2FC 
...
```{r}
#read data
data <- read.csv("data/table_CD_Ileum_vs_nonIBD_Ileum.tab", sep= "\t")#input file may change depend on the analysis 
...
write.table(merged.data, "output/mbxData",row.names = FALSE, quote = FALSE, sep="\t")
