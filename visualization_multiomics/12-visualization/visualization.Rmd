...
RCy3::setEdgeTargetArrowMapping('EndArrow',c('mim-conversion','mim-catalysis', 'Arrow', 'mim-stimulation'),c('Delta','Open Circle','Delta', 'Open Delta'), style.name="pathwayStyle")
